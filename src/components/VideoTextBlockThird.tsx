...
const VideoTextBlockThird = () => {
  ...
  return (
    <section className="w-full bg-[#030411] text-white py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      >
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          >
            <motion.h2
              variants={itemVariants}
              className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-lime-400 to-emerald-700 bg-clip-text text-transparent mb-4 sm:mb-6"
            >
              {t("title")}
            </motion.h2>
            <motion.p
